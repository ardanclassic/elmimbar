...
import LogoDark from "@/assets/logo/Image Only - Black - cropped.png";
import LogoLight from "@/assets/logo/Image Only - Light - cropped.png";
...
const ThemeLogoImageOnly = ({ className = "", alt = "Logo", width, height, priority = false }: ThemeLogoProps) => {
...
export default ThemeLogoImageOnly;
